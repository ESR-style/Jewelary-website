      ...
      {isOpen && (
        <div className="md:hidden bg-white shadow-md p-4">
          <div className="flex flex-col space-y-4">
            <Link to="/Whishlist" className="flex items-center text-gray-600 hover:text-gold-500">
            ...
            <Link to="/store" className="flex items-center text-gray-600 hover:text-gold-500">
